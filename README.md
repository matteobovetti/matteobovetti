...
I'm specilized in [data intesive application](https://www.oreilly.com/library/view/designing-data-intensive-applications/9781098119058/), mostry for data streaming application.
I have also spent 8+ years in building backend microservices for enterprise and SaaS products.

## ✍️ Open Source

I'm currently focused on [VaireDB](https://github.com/matteobovetti/vairedb), a cloud native analytical database written in `Rust`.
Take a look [When is a good idea to use it](https://github.com/matteobovetti/vairedb/blob/main/README.md#when-use-vairedb).
